...
public class MovieInfoService {
    ...
    public CatalogItem getCatalogItem(Rating rating) {
        ...
        return new CatalogItem(movie.getName(), movie.getDescription(), rating.getRating(),movie.getMovieId());
    }

    public CatalogItem getFallbackCatalogItem(Rating rating) {
        return new CatalogItem("Movie name not found", "", rating.getRating(),"-1");
    }
}
